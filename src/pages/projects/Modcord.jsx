  ...
  return (
    <header className="text-center mb-16 max-w-4xl mx-auto">
      <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-gray-900 mb-6 leading-tight">
        {MODCORD_CONTENT.headerTitle.replace('Smart AI Moderation', '')}
        <span className="accent-text">Smart AI Moderation</span> for Your Discord Server
      </h1>
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
        {MODCORD_CONTENT.heroButtons.map((btn) => (
          ...
          >
            {btn.icon === 'discord' && <img src={ICON_PATHS.discord} alt="Discord" className="w-5 h-5" />}
            {btn.icon === 'github' && <img src={ICON_PATHS.github} alt="GitHub" className="w-5 h-5" />}
            {btn.label}
          </Button>
        ))}
      </div>
    ...
    <section className="text-center">
      <div className="card-glass p-8 max-w-4xl mx-auto bg-linear-to-r from-blue-50/50 to-purple-50/50">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <Link to="/contact" className="btn-primary inline-flex items-center gap-2" style={gradientStyle('orangePurple')}>
