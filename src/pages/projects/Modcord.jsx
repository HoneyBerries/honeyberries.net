  ...
  return (
    <header className="text-center mb-16 max-w-4xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
        ...
        <button className="inline-flex items-center gap-2 px-6 py-3 border-2 border-gray-300 text-gray-700 font-semibold rounded-xl hover:border-gray-400 hover:bg-gray-50 transition-all duration-300">
          📖 Documentation
        </button>
      </div>
    </header>
    ...
    <section className="text-center">
      <div className="card-glass p-8 max-w-4xl mx-auto bg-gradient-to-r from-blue-50/50 to-purple-50/50">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <a href="/contact" className="inline-flex items-center gap-2 px-6 py-3 text-gray-700 font-semibold hover:text-gray-900 transition-colors">
