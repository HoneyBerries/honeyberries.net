    ...
    <header className="text-center mb-16 max-w-4xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
        <Button
          ...
          style={{background: 'linear-gradient(135deg, #22c55e 0%, #0891b2 100%)'}}
        >
          <img src="/assets/icons/discord-icon.svg" alt="Discord" className="w-5 h-5" />
          Add to Discord
        </Button>
        <Button
          as="a"
          ...
          className="rounded-lg whitespace-nowrap gap-2"
        >
          <img src="/assets/icons/github-icon.svg" alt="GitHub" className="w-5 h-5" />
          View Github Repo
        </Button>
      </div>
    </header>
    ...
    <section className="text-center">
      <div className="card-glass p-8 max-w-4xl mx-auto bg-gradient-to-r from-blue-50/50 to-purple-50/50">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <Link to="/contact" className="btn-primary inline-flex items-center gap-2" style={{background: 'linear-gradient(135deg, #f97316 0%, #c084fc 100%)'}}>
