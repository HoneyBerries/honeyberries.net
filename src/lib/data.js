/**
 * Project and content data used across the site
 * Contains all structured data for projects, timeline, gems, and features
 */

// Background image paths (served from public folder for stable URLs)
const BACKGROUNDS = {
...
/**
 * Main projects displayed on the Projects page
 */
...
/**
 * Timeline data for About page journey section
 */
...
/**
 * Current projects list for About page
 */
