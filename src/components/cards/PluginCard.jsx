...
/**
 * Plugin card component for displaying Modrinth projects
 * Shows project info, download counts, and action buttons
 */
export default function PluginCard({ project }) {
  // Stable seed for gradient generation
  const seed = useMemo(() => 
          ...
          <div className="flex gap-4 p-4">
            ...
            <div className="shrink-0">
              <div 
                ...
                className="w-20 h-20 rounded-lg overflow-hidden flex items-center justify-center p-1"
              >
