import type { HeadlinePart, HeroCta, Stat, SkillCategory, SuggestedLink, FloatingElement, ModcordFeature } from '$lib/types';
import { CONTACT_INFO, MINECRAFT_SERVER, EXTERNAL_LINKS } from '$lib/constants';
...
export const CONTACT_CONTENT: {
  ...
  footerContact: typeof CONTACT_INFO;
} = {
