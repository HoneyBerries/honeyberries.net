# HoneyBerries.net Portfolio

This is the source code for my personal portfolio website, HoneyBerries.net. It's a modern, responsive single-page application built with React.
