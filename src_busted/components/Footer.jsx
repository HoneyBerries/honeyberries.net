    ...
    <footer className="border-t border-gray-200 mt-16" role="contentinfo">
      <div className="max-w-6xl mx-auto px-4 py-8 text-sm text-gray-600 flex flex-col sm:flex-row items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-4">
          <Link to="/projects/modcord/privacy-policy" className="text-gray-600 hover:text-gray-900">Privacy Policy</Link>
          <Link to="/projects/modcord/terms-of-service" className="text-gray-600 hover:text-gray-900">Terms of Service</Link>
        </div>
      </div>
    </footer>
  );
